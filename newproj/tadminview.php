...
<tr>
    ...
    if ($row['rate']== 1) {
        ...
        echo '<p><a href="status.php?id='.$row['id'].'&rate=1" style="margin-left:-30px;"class="btn btn-warning id="filter">Ongoing</a> 
        <a class="btn btn-warning" href=tadminview.php?id=$e_id data-bs-toggle="modal" data-bs-target="#myModal"> note </a>
<br>
                    <input style="width:165px; margin-left:-45px; font-size:18px;" type="text" class="form-control form-control-lg bg-light fs-6" name="note"  value='.$note.'></p>';
    }else{
